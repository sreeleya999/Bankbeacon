...
class GoldReq extends StatefulWidget {
   GoldReq({Key? key,required this.uid,required this.type}) : super(key: key);
var uid,type;
  @override
  State<GoldReq> createState() => _GoldReqState();
}

class _GoldReqState extends State<GoldReq> {
