...
class EducationRequest extends StatefulWidget {
 EducationRequest({Key? key,required this.uid,required this.type}) : super(key: key);
var uid,type;
  @override
  State<EducationRequest> createState() => _EducationRequestState();
}

class _EducationRequestState extends State<EducationRequest> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
          title: Text("Education Loan Request"),
